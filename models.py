...
class Mangas(db.Model):
    ...
    sinopsis = db.Column(db.String(225),nullable=False)
    generos = db.Column(db.String(225),nullable=False)
    estatus = db.Column(db.String(225),nullable=False)
    idioma = db.Column(db.String(225),nullable=False)


    def __init__(self,id_manga,nombre,sinopsis,generos,estatus,idioma):
